...
import com.flowdy.demoreactive.entity.Tutorial;
import com.flowdy.demoreactive.service.TutorialService;
...
public class TutorialController {
  ...
  public Flux<Tutorial> getAllTutorials(@RequestParam(required = false) String title) {
    ...
    else return tutorialService.findByTitleContaining(title);
  }
  ...
  public Mono<Tutorial> createTutorial(@RequestBody @NotNull Tutorial request) {
    Tutorial tutorial = new Tutorial(request.getTitle(), request.getDescription(), false);
